...
| Hinglish handling | ❌ | ✅ indic-transliteration (ITRANS-scheme) |
...
**Backend** — FastAPI · HuggingFace Transformers (NLLB-200) · OpenAI Whisper · gTTS · indic-transliteration
...
**Serving** — Single FastAPI process serves both the API and the UI together
...
- [ ] Fine-tune on **Samanantar** / **FLORES-200**, benchmark BLEU & chrF vs. the LSTM baseline
- [ ] Swap gTTS for **Coqui TTS** for offline, higher-quality voice output
- [ ] Batch / document translation mode
